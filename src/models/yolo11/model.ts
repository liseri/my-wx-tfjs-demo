...
export class ObjectDetection {
  ...
  load() {
    return new Promise((resolve, reject) => {
       ...
       const modelPath = `${wx.env.USER_DATA_PATH}/yolo11s_roboflow.onnx`;
       ...
       // 判断之前是否已经下载过onnx模型
        wx.getFileSystemManager().access({
          ...
          fail: (res) => {
            ...
            const cloudPath = 'https://objectstorageapi.bja.sealos.run/b75r8m7e-models/yolo11n_tfjs/yolo11s_roboflow.onnx'
            this.downloadFile(cloudPath, function(r) {
              ...
              wx.getFileSystemManager().saveFile({
                ...
                success: (res) => { // 注册回调函数
                  console.log(res)
                  // const modelPath = res.savedFilePath +'/yolo11s_roboflow.onnx'
